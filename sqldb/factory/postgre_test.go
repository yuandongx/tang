...
func TestPostgresModel_CreateCaseInt(t *testing.T) {
	...
	got, got1 := m1.Create()
	want1 := "CREATE TABLE tang_test_case_int(aint integer NOT NULL, bint16 smallint NOT NULL, cint32 integer NOT NULL, dint8 smallint NOT NULL, eint64 bigint NOT NULL, id serial, PRIMARY KEY(id));"
	if want1 == got {
		t.Log(got, got1)
	} else {
